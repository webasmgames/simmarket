...
|---|---|---|
| 1 | [phase1-lob.md](TODO/phase1-lob.md) | Limit Order Book + matching engine (pure Rust, no agents, no WASM) |
| 2 | [phase2-tick-noise.md](TODO/phase2-tick-noise.md) | Tick engine + noise trader archetype, headless CSV output |
